...
const sevConfig: Record<Severity, { bg: string; text: string; border: string; icon: typeof AlertTriangle; ring: string }> = {
  CRITICAL: { bg: 'bg-red-50 dark:bg-red-950/50', text: 'text-red-700 dark:text-red-300', border: 'border-red-300 dark:border-red-800', icon: AlertTriangle, ring: 'ring-red-200 dark:ring-red-800/50' },
  HIGH: { bg: 'bg-orange-50 dark:bg-orange-950/50', text: 'text-orange-700 dark:text-orange-300', border: 'border-orange-300 dark:border-orange-800', icon: ArrowUpCircle, ring: 'ring-orange-200 dark:ring-orange-800/50' },
  MEDIUM: { bg: 'bg-amber-50 dark:bg-amber-950/50', text: 'text-amber-700 dark:text-amber-300', border: 'border-amber-300 dark:border-amber-800', icon: AlertCircle, ring: 'ring-amber-200 dark:ring-amber-800/50' },
  NORMAL: { bg: 'bg-green-50 dark:bg-green-950/50', text: 'text-green-700 dark:text-green-300', border: 'border-green-300 dark:border-green-800', icon: CheckCircle2, ring: 'ring-green-200 dark:ring-green-800/50' },
};
...
const stateConfig: Record<AlertState, { bg: string; text: string; border: string; dot: string }> = {
  ...
  CONTAINED: { bg: 'bg-blue-50 dark:bg-blue-950/50', text: 'text-blue-700 dark:text-blue-300', border: 'border-blue-300 dark:border-blue-800', dot: 'bg-blue-500' },
